...
It´s a practical and economical way for families and larger groups to have an rental accommodation beside hotels.You come closer to the beach and have more like a home accomodation.
...
## Contents
**Navigation Bar**
There is a navigation bar, visible on every page and you can in easy way keep track which side you are heading for the moment with a frame mark of the side name i the nav.bar
...
You can also hover over the menu and you see a hand mark.
...
I also made the website a little more personal to have an own icon in head, with same colours and font as the webside.
...
- I have create an own Head icon to use in head, with same font and colour as the pages.
...
That can lead to more traffic and the object will get attention to more people and more revenue for me.

**Gallery**
Upload more and updated pictures.

**Contact page**
1.I can also add a calender, where they can see the available dates right away.
...
## Testing Responsive
I have tested in two different websites. See print screen below.
...
## Bugs
### Through testing I found bugs that are resolved:
- Uploaded new Photos with smaller sizes.
 When I run it through Lighthouse I noticed "Header" and "House" picture was too large and I also "Beach" picture got pixelated on large screens.
...
Readme is written in VS code space / Git Hub and I have pull and push between code space and repository.
...
-Map is from Google map and is copied from a link with that view the specific location
...
- My mentor Gareth
- My student fellow Josefin Yoshida-Dahlqvist, who has supported me through the project
- My studentfellows on slack with quick response of all my questions
- Kristyna, who has a good pep attitude and helpful in a clearly way
